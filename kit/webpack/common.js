...
export const css = {
  // CSS loader configuration -- plain CSS, SASS
  rules: [
    {
      ext: 'css',
      use: [],
  ...
  getDevLoaders() {
    return (function* loadCss() {
      for (const loader of css.rules) {
        // Iterate over CSS/SASS and yield local and global mod configs
...
export function webpackProgress(what = chalk.magenta.bold(process.env.APP_NAME)) {
